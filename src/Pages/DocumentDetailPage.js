...
const DocumentDetailPage = () => {
  ...
  const getCategoryName = (originalCategoryName) => {
    switch (originalCategoryName) {
      case "enterprise_network_system":
        return "Network";
      case "enterprise_system":
        return "System";
      case "enterprise_database_system":
        return "Database";
      case "enterprise_card_system":
        return "Card System";
      case "enterprise_software_solutions":
        return "Application";
      case "peripherals_devices":
        return "Peripherals Devices";
      case "personal_computing":
        return "Personal Computing";
      case "data_center_devices":
        return "Data Center Passive Items";
      default:
